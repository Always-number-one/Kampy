...
class _CreateBlogState extends State<CreateBlog> {
  ...
  final postRef = FirebaseDatabase.instance.ref().child('Events');
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          postRef
                              ...
                              .set({
                            'eId': date.toString(),
                            'eImage': newUrl.toString(),
                            'eTime': date.toString(),
                            'eLocalisation': localisationController.text.toString(),
                            'eDescription':
                                descriptionController.text.toString(),
                            'uEmail': user!.email.toString(),
                            'uid': user.uid.toString(),
                          }).then((value) {
                            toastMessage("Event Published");
                            setState(() {
                              showSpinner = false;
                            });
